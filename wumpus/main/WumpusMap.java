...
/* WumpusMap -- This class represents the entire game map.  The vertices of a dodecahedron are the rooms and the edges
...
public class WumpusMap {
	...
	// returns the direction string for the integer direction
	...
	// returns direction integer for the direction string
	...
	// returns the pointer for the passed index
	public WumpusRoom getRoom(int ndx) {
		return rooms[ndx];
	}
	
	// returns a random empty room (with no room elements)
